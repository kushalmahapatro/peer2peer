...
class Peer2PeerWire implements FlutterRustBridgeWireBase {
  ...
  Peer2PeerWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Peer2PeerWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
  ...
  late final _wire_print_helloPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>('wire_print_hello');
  late final _wire_print_hello = _wire_print_helloPtr.asFunction<void Function(int)>();
  ...
  late final _wire_addPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_add');
