...
fn wire_get_ip_one_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        WrapInfo {
            debug_name: "get_ip_one",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| get_ip_one(),
    )
}
fn wire_tick_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, (), _>(
        ...
        move || move |task_callback| tick(task_callback.stream_sink::<_, i32>()),
    )
}
fn wire_start_p2p_impl(port_: MessagePort, address: impl Wire2Api<Option<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        WrapInfo {
            debug_name: "start_p2p",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_address = address.wire2api();
            move |task_callback| start_p2p(api_address)
        },
    )
}
...
mod web {
    ...
    #[wasm_bindgen]
    pub fn wire_get_ip_one(port_: MessagePort) {
    ...
    #[wasm_bindgen]
    pub fn wire_start_p2p(port_: MessagePort, address: Option<String>) {
